...
<div class="container">
    ...
    <!-- card > form input name, email, password, thumbnail, role [user,admin] default user -->
    <div class="card">
        <div class="card-body">
            <form action="/admin/user/do.php" method="post">
                <div class="form-group">
                    <label class="form-label" for="thumbnail">รูปประจำตัว</label>
                    <input type="file" class="form-control mb-3" id="thumbnail" name="thumbnail" placeholder="รูปประจำตัว">
                </div>
                <div class="form-group">
